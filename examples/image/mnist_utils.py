...
def animate_mnist_examples(train_history, x_test, examples_indices, model_name):
    ...
    for t in range(len(sel_scores_history)):
        ...
        big_score = np.concatenate([
            np.concatenate([sel_scores_history[t][0, :, :, 0], sel_scores_history[t][1, :, :, 0],
                            sel_scores_history[t][2, :, :, 0]], axis=0),
            np.concatenate([sel_scores_history[t][3, :, :, 0], sel_scores_history[t][4, :, :, 0],
                            sel_scores_history[t][5, :, :, 0]], axis=0),
            np.concatenate([sel_scores_history[t][6, :, :, 0], sel_scores_history[t][7, :, :, 0],
                            sel_scores_history[t][8, :, :, 0]], axis=0),
        ], axis=1)
