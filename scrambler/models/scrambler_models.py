...
from tensorflow.keras.layers import Conv2D, BatchNormalization, Permute
from tensorflow.keras.layers import Concatenate, Reshape, Softmax, Embedding, Multiply
from tensorflow.keras.callbacks import ModelCheckpoint, EarlyStopping, Callback
import tensorflow_probability as tfp #add this to get to TF2
...
def contain_tf_gpu_mem_usage():
    config = tf1.ConfigProto()#.ConfigProto()
...
class InstanceNormalization(Layer):
    ...
    def call(self, inputs):
        ...
        # override get_config to update to tf2 and new keras support
...
def st_sampled_softmax(logits):
    with ops.name_scope("STSampledSoftmax") as namescope:
        ...
        #tf multinomial is now tf.random.categorial
        ...
        with tf1.get_default_graph().gradient_override_map({'Ceil': 'Identity', 'Mul': 'STMul'}):
...
class Scrambler:
    ...
    def _optimize(self, predictor, finetuner, pretrained_scores, x, y, batch_size, n_iters, opt_mode, drop=None,
        ...
        opt = tf.keras.optimizers.Adam(lr=adam_lr, beta_1=adam_beta_1, beta_2=adam_beta_2)
